...
.single_file_to_db <- function(file_path, fileId, projectTitle, projectId) {
    ...
    if(!file_exists_in_db){
        ...
        assay_tbl_recast <- assay_tbl %>%
            ...
            mutate(across(where(is.raw), as.logical))
